...
class Footer extends Component {
  render() {
    return (
      <FooterCSS style={{backgroundColor:"white",paddingTop: "25px",paddingBottom: "25px", color: "#00334C",margin:"10px 0px 0px 0px", borderTop: "3px solid #005D8C"}} className={this.props.className}>
        ...
        <StyledFooterLink style={{color:"#00334C"}} to="/contacts">Contact </StyledFooterLink>
      </FooterCSS>
    );
  }
}
